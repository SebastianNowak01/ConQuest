...
fun getTopAppBarConfig(route: String?, noDrawerRoutes: List<String>): MyTopAppBar {
    return when {
        ...
        route == "com.maeldev.conquest.screens.SettingsScreenParams" -> MyTopAppBar.Settings
        route == "com.maeldev.conquest.screens.cosplay.Events" -> MyTopAppBar.Events
        route.startsWith("com.maeldev.conquest.screens.cosplay.Progress") -> MyTopAppBar.Progress
        route.startsWith("com.maeldev.conquest.screens.cosplay.Stats") -> MyTopAppBar.Stats
        route.startsWith("com.maeldev.conquest.screens.cosplay.") -> MyTopAppBar.Cosplay
