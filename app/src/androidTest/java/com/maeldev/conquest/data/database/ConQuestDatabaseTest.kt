...
class ConQuestDatabaseTest {
    ...
    fun createDb() {
        ...
        db =
            Room.inMemoryDatabaseBuilder(context, CosplayDatabase::class.java)
    ...
    @Test
    fun cascadeDeleteCosplayDeletesTasks() =
        runBlocking {
    ...
    fun getTasksWithActiveAlarms() =
        runBlocking {
            ...
            val futureTask =
                CosplayTask(id = 2, cosplayId = 1, taskName = "T2", done = false, alarm = true, notes = null, date = futureDate)
            val futureNoAlarmTask =
                CosplayTask(id = 3, cosplayId = 1, taskName = "T3", done = false, alarm = false, notes = null, date = futureDate)
